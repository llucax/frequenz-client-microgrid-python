...
async def test_components() -> None:
    ...
    assert set(await microgrid.components()) == {Component(0, ComponentCategory.METER)}
...
async def test_bad_connections() -> None:
    ...
    assert set(await microgrid.connections(starts={1, 7}, ends={3, 9})) == unfiltered


async def test_meter_data() -> None:
...
async def test_battery_data() -> None:
...
async def test_inverter_data() -> None:
...
async def test_ev_charger_data() -> None:
    """Test the ev_charger_data() method."""
    servicer.add_component(83, PbComponentCategory.COMPONENT_CATEGORY_EV_CHARGER)
    servicer.add_component(38, PbComponentCategory.COMPONENT_CATEGORY_BATTERY)
...
async def test_set_bounds() -> None:
